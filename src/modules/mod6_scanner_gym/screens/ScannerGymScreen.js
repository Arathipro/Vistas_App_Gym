  ...
  return (
    <View style={s.container}>
      <View style={s.header}>
        ...
        <TouchableOpacity style={s.badge} onPress={() => navigation.navigate('CatalogoGym')}><Text style={s.badgeText}>📚</Text>{machineCatalog.length > 0 && <View style={s.dot} />}</TouchableOpacity>
      </View>
      <ScrollView contentContainerStyle={s.body} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={s.catalogBtn} onPress={() => navigation.navigate('CatalogoGym')}><Text style={s.catalogText}>📚 Ver catálogo de escaneos guardados ({machineCatalog.length})</Text></TouchableOpacity>
      </ScrollView>
    </View>
  );
}
